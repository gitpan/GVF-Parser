...
#     AUTHOR => q[Please contact me with any issue, method ideas/improvments or documentation matters. , Shawn Rynearson <shawn.rynerson@gmail.com>]
...
PARENT_NAME = GVF
DLBASE = $(BASEEXT)
VERSION_FROM = lib/GVF/Parser.pm
OBJECT = 
LDFROM = $(OBJECT)
LINKTYPE = dynamic
BOOTDEP = 
...
H_FILES  = 
MAN1PODS = 
MAN3PODS = lib/GVF/Parser.pm

# Where is the Config information that we are using/depend on
CONFIGDEP = $(PERL_ARCHLIB)$(DFSEP)Config.pm $(PERL_INC)$(DFSEP)config.h

# Where to build things
INST_LIBDIR      = $(INST_LIB)/GVF
INST_ARCHLIBDIR  = $(INST_ARCHLIB)/GVF
...
TO_INST_PM = lib/GVF/DB/File.pm \
	lib/GVF/DB/File/Result/Attributes.pm \
	lib/GVF/DB/File/Result/Features.pm \
	lib/GVF/Parser.pm \
	lib/GVF/Request.pm \
	lib/GVF/Roles.pm \
	lib/GVF/Storage/SQLite_GVF.pm \
	lib/GVF/Utils.pm

PM_TO_BLIB = lib/GVF/Utils.pm \
	blib/lib/GVF/Utils.pm \
	lib/GVF/Request.pm \
	blib/lib/GVF/Request.pm \
	lib/GVF/Parser.pm \
	blib/lib/GVF/Parser.pm \
	lib/GVF/DB/File/Result/Attributes.pm \
	blib/lib/GVF/DB/File/Result/Attributes.pm \
	lib/GVF/Roles.pm \
	blib/lib/GVF/Roles.pm \
	lib/GVF/Storage/SQLite_GVF.pm \
	blib/lib/GVF/Storage/SQLite_GVF.pm \
	lib/GVF/DB/File.pm \
	blib/lib/GVF/DB/File.pm \
	lib/GVF/DB/File/Result/Features.pm \
	blib/lib/GVF/DB/File/Result/Features.pm
...
manifypods : pure_all  \
	...
	$(NOECHO) $(POD2MAN) --section=3 --perm_rw=$(PERM_RW) \
	  lib/GVF/Parser.pm $(INST_MAN3DIR)/GVF::Parser.$(MAN3EXT) 
...
pm_to_blib : $(FIRST_MAKEFILE) $(TO_INST_PM)
	$(NOECHO) $(ABSPERLRUN) -MExtUtils::Install -e 'pm_to_blib({@ARGV}, '\''$(INST_LIB)/auto'\'', q[$(PM_FILTER)], '\''$(PERM_DIR)'\'')' -- \
	  lib/GVF/Utils.pm blib/lib/GVF/Utils.pm \
	  lib/GVF/Request.pm blib/lib/GVF/Request.pm \
	  lib/GVF/Parser.pm blib/lib/GVF/Parser.pm \
	  lib/GVF/DB/File/Result/Attributes.pm blib/lib/GVF/DB/File/Result/Attributes.pm \
	  lib/GVF/Roles.pm blib/lib/GVF/Roles.pm \
	  lib/GVF/Storage/SQLite_GVF.pm blib/lib/GVF/Storage/SQLite_GVF.pm \
	  lib/GVF/DB/File.pm blib/lib/GVF/DB/File.pm \
	  lib/GVF/DB/File/Result/Features.pm blib/lib/GVF/DB/File/Result/Features.pm 
